...
def edit_movie():
    ...
    try:
        ...
        year = input(
            'Enter the movie year (or press Enter to keep current value(s)): ')
        genre = input(
            'Enter the movie genre (or press Enter to keep current value(s)): ')
        director = input(
            'Enter the movie director (or press Enter to keep current value(s)): ')
        actors = input(
            'Enter the name of actors(comma separated) (or press Enter to keep current value(s)): ')
